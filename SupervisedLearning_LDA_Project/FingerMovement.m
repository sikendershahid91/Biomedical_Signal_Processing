...
daubechies_WT = 'db5';
train_WaveletCoefficentMatrix_c3 = zeros(length(train_label),7,length(train_set_c3(1,:)));
train_WaveletCoefficentMatrix_c4 = zeros(length(train_label),7,length(train_set_c4(1,:)));
